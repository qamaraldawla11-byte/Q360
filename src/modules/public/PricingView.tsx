    ...
    return (
        <div style={{ minHeight: '100vh', background: 'var(--bg-app)', fontFamily: 'var(--font-sans)', padding: '60px 20px' }}>
            ...
            <div style={{ textAlign: 'center', marginBottom: '60px' }}>
                ...
                <p style={{ fontSize: '18px', color: 'var(--fg-secondary)' }}>Pricing is being shaped during the Q360 beta.</p>
            </div>

            <div style={{ maxWidth: '1200px', margin: '0 auto', display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '32px' }}>
                {[
                    { name: 'Beta Access', price: 'Invite', desc: 'For early businesses testing one important workflow.', btn: 'Request beta access', primary: true, outline: false },
                    { name: 'Business Workspace', price: 'Planned', desc: 'For teams that manage customers, orders, invoices, and payment follow-up.', btn: 'Join the beta', outline: true },
                    ...
                    <div key={plan.name} style={{
                        ...
                        <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
                            {['Founder-supported beta access', 'Selected workflow setup', 'Daily operations workspace', 'Q suggestions where available'].map(feat => (
