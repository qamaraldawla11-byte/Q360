...
export const OrderHistoryView = () => {
    ...
    const visible = useMemo(() => orders.filter(order => {
        ...
        return `${order.displayOrderNumber} ${table} ${order.customerName || ''} ${order.customerPhone || ''} ${order.status} ${order.paymentStatus}`.toLowerCase().includes(query.trim().toLowerCase());
