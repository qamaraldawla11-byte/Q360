...
export const OrderHistoryView = () => {
    ...
    return <div className="order-history">
        ...
        <div className="history-table"><table><thead><tr><th>Order</th><th>Service</th><th>Date & time</th><th>Items</th><th>Total</th><th>Service status</th><th>Payment record</th><th>Document</th></tr></thead><tbody>
            {visible.map((order) => {
                ...
                return <tr key={order.id}>
                    ...
                    <td><span className={'status status--' + order.status}>{order.status.replace('_', ' ')}</span>{order.cancellationReason && <small>{order.cancellationReason}</small>}</td>
